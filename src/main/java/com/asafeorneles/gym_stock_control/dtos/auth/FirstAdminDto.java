...
public record FirstAdminDto(
        ...
        @Size(min = 4, max = 100, message = "The username should be between 4 and 100 characters")
        @Pattern(regexp = "^[a-zA-Z0-9._-]+$", message = "The username must contain only letters, numbers, periods, dashes, or underscores.")
        String username,
        @NotBlank(message = "The password cannot be empty!")
        @Size(min = 4, max = 100, message = "The password should be between 4 and 100 characters")
//        @Pattern(
