...
public class ProductInventoryMapper {
    ...
    public static void patchProductInventoryLowStockThreshold(ProductInventory productInventory, PatchProductInventoryLowStockThreshold patchProductInventoryLowStockThreshold){
